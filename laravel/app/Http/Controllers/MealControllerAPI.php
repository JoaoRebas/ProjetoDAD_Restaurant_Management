...
class MealControllerAPI extends Controller
{
  ...
  public function getAllMealsTip(Request $request){
    return MealResource::collection(Meal::where('tips', '<>',0 )->paginate(10));
  }
  ...
  public function addTips(Request $request, $id)
  {
